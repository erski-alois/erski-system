...
def create_registration(member_id, data):
    ...
    cur = conn.execute(
        """INSERT INTO csia_registrations (
            ...
            address_chinese, address_street, address_city, address_country, address_province,
        ...
        (
            ...
            data.get("address_chinese"), data.get("address_street"), data.get("address_city"), data.get("address_country"),
            data.get("address_province"), data.get("address_postal_code"), data.get("address_other"),
